...
function displayData() {
  bCity.innerHTML =
    ...
    bResults.current.weather[0].icon +
    '@2x.png>'
  ...
  if (bResults.current.uvi <= 2) {
    uvbg.style =
      'border-style: solid; background-color: lightgreen; color: blue;'
    ...
    uvbg.style =
      'border-style: solid; background-color: orangered; color: white;'
  }
  console.log('hmm')
}
...
function displayPanelData() {
  date1.textContent = moment()
    .add(1, 'days')
    .format('M' + '/' + 'D')
  icon1.innerHTML =
    '<img src=http://openweathermap.org/img/wn/' +
    bResults.daily[0].weather[0].icon +
    '@2x.png>'
  ...
  date2.textContent = moment()
    .add(2, 'days')
    .format('M' + '/' + 'D')
  icon2.innerHTML =
    '<img src=http://openweathermap.org/img/wn/' +
    bResults.daily[1].weather[0].icon +
    '@2x.png>'
  ...
  date3.textContent = moment()
    .add(3, 'days')
    .format('M' + '/' + 'D')
  icon3.innerHTML =
    '<img src=http://openweathermap.org/img/wn/' +
    bResults.daily[2].weather[0].icon +
    '@2x.png>'
  ...
  date4.textContent = moment()
    .add(4, 'days')
    .format('M' + '/' + 'D')
  icon4.innerHTML =
    '<img src=http://openweathermap.org/img/wn/' +
    bResults.daily[3].weather[0].icon +
    '@2x.png>'
  ...
  date5.textContent = moment()
    .add(5, 'days')
    .format('M' + '/' + 'D')
  icon5.innerHTML =
    '<img src=http://openweathermap.org/img/wn/' +
    bResults.daily[4].weather[0].icon +
    '@2x.png>'
